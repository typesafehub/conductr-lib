...
* `"com.typesafe.conductr" %  "conductr-bundle-lib"         % "1.4.7"`
* `"com.typesafe.conductr" %  "java-conductr-bundle-lib"    % "1.4.7"`
* `"com.typesafe.conductr" %% "scala-conductr-bundle-lib"   % "1.4.7"`
* `"com.typesafe.conductr" %% "akka23-conductr-bundle-lib"  % "1.4.7"`
