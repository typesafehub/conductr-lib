...
* `"com.typesafe.conductr" %  "conductr-bundle-lib"         % "1.4.9"`
* `"com.typesafe.conductr" %  "java-conductr-bundle-lib"    % "1.4.9"`
* `"com.typesafe.conductr" %% "scala-conductr-bundle-lib"   % "1.4.9"`
* `"com.typesafe.conductr" %% "akka23-conductr-bundle-lib"  % "1.4.9"`
* `"com.typesafe.conductr" %% "akka24-conductr-bundle-lib"  % "1.4.9"`
* `"com.typesafe.conductr" %% "play23-conductr-bundle-lib"  % "1.4.9"`
* `"com.typesafe.conductr" %% "play24-conductr-bundle-lib"  % "1.4.9"`
* `"com.typesafe.conductr" %% "play25-conductr-bundle-lib"  % "1.4.9"`
* `"com.typesafe.conductr" %% "lagom1-conductr-bundle-lib"  % "1.4.9"`
