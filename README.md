...
* `"com.typesafe.conductr" %  "java-conductr-bundle-lib"    % "1.4.5"`
* `"com.typesafe.conductr" %% "scala-conductr-bundle-lib"   % "1.4.5"`
* `"com.typesafe.conductr" %% "akka23-conductr-bundle-lib"  % "1.4.5"`
* `"com.typesafe.conductr" %% "akka24-conductr-bundle-lib"  % "1.4.5"`
* `"com.typesafe.conductr" %% "play23-conductr-bundle-lib"  % "1.4.5"`
* `"com.typesafe.conductr" %% "play24-conductr-bundle-lib"  % "1.4.5"`
* `"com.typesafe.conductr" %% "play25-conductr-bundle-lib"  % "1.4.5"`
* `"com.typesafe.conductr" %% "lagom10-conductr-bundle-lib" % "1.4.5"`
