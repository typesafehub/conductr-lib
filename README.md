...
* `"com.typesafe.conductr" %  "conductr-bundle-lib"        % "0.10.2"`
* `"com.typesafe.conductr" %% "scala-conductr-bundle-lib"  % "0.10.2"`
* `"com.typesafe.conductr" %% "akka23-conductr-bundle-lib" % "0.10.2"`
* `"com.typesafe.conductr" %% "play23-conductr-bundle-lib" % "0.10.2"`
* `"com.typesafe.conductr" %% "play24-conductr-bundle-lib" % "0.10.2"`
