 ...
 */
class ConductRServiceLocator(locationService: LocationService, cache: CacheLike, circuitBreakers: CircuitBreakers)(implicit ec: ExecutionContext) extends CircuitBreakingServiceLocator(circuitBreakers) {
